...
&=(-1)^p\left(\sum_{i=p+1}^{n+1}(-1)^i(\lambda^0_iSu-\lambda^1_iSu)+\sum_{i=p+1}^n(-1)^i(S\lambda^0_iu-S\lambda^1_iu)\right)\\
&=(-1)^p(-1)^{p+1}(u-K(B^pu,F^pu))+\\
&\phantomop(-1)^p\sum_{i=p+2}^{n+1}(-1)^i(S\lambda^0_{i-1}u-S\lambda^1_{i-1}u)+\\
&\phantomop(-1)^p\sum_{i=p+1}^n(-1)^i(S\lambda^0_iu-S\lambda^1_iu)\\
&=K(B^pu,F^pu)-u\\
&=\psi^p\varphi^pu-u.
\end{align*}
