...
\end{proposition}
\begin{proof}
Denotiamo con $E^{p,q}_r$ la successione spettrale coomologica associata alla fibrazione. Per ipotesi $H^i(B;A)$ è un $A$-modulo libero finitamente generato per ogni $i$, dunque per \missing{} $E_2$ è isomorfo come $A$-algebra a $H^*(B;A)\tensor H^*(F;A)$. Pertanto, per ogni grado totale $n$, $E_2$ ha al più due termini $E^{i,j}_2$ non nulli, corrispondenti a $i=0$ e $i=k$. Applicando la \thref{cohomological-spectral-exact-sequence} (è evidente che le ipotesi sono soddisfatte) otteniamo la successione esatta
\begin{diagram}
