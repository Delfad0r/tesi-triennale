...
\todo{Questa sezione è troppo corta, e si vede!}
...
\begin{theorem}\thlabel{spectral-sequence-of-fibration-E-2}
...
\longexactsequence{H_{p+q-1}(F;G)\rar\&H_{p+q-1}(E;G)\rar\&H_{p+q-1}(B;G)\rar{d_{p+q-1}}\&H_{p+q-2}(F;G)\rar\&\ldots}{\ldots\rar\&H_2(B;G)\rar{d_2}\&H_1(F;G)\rar\&H_1(E;G)\rar\&H_1(B;G).}
%\begin{diagram}
%H_{p+q-1}(F;G)\rar&H_{p+q-1}(E;G)\rar&H_{p+q-1}(B;G)\rar{d_{p+q-1}}&H_{p+q-2}(F;G)\rar&\ldots\\
%\ldots\rar&H_2(B;G)\rar{d_2}&H_1(F;G)\rar&H_1(E;G)\rar&H_1(B;G).
%\end{diagram}
\end{proposition}
\begin{proof}
