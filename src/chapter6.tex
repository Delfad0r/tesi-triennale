...
\begin{definition}
Uno spazio topologico $X$ si dice uniformemente localmente contrattile (ULC)\footnote{La definizione che proponiamo è più esigente di quella comunemente utilizzata in letteratura (ad esempio in \citenumber{serre1951}{5}{1}) al fine di facilitare le dimostrazioni.} se esistono un intorno $U$ della diagonale $\Delta\subs X\times X$ e un'omotopia $\map{H}{U\times I}{X}$ tale che
\begin{enumerate}
