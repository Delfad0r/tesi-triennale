...
\end{proof}
Osserviamo che, per $n\ge 1$, $X_n$ è un H-spazio, dunque il suo gruppo fondamentale agisce banalmente sui gruppi di omologia e coomologia di $T_n$ (\thref{h-space-trivial-action}).
...
\end{proposition}
\begin{proof}
La tesi è sicuramente vera per $X_0$ per ipotesi e per $T_1$ poiché $T_1=X_0$. Dalla \thref{loop-space-finitely-generated-homology} segue che se la tesi vale per $T_i$ allora vale anche per $X_i$, mentre dalla \thref{homology-of-universal-covering-finitely-generated} si ottiene che se la tesi è vera per $X_i$ allora è vera anche per $T_{i+1}$ (ricordiamo che il gruppo fondamentale di $X_i$ agisce banalmente sull'omologia di $T_{i+1}$). Per induzione si ha la tesi per ogni $i$.
\end{proof}
