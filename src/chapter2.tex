...
\]
per ogni \(\epsilon_1,\ldots,\epsilon_n\in\{0,1\}\). Seguono in modo naturale le definizioni di \(D_\bullet(X/x_0)\), \(C_\bullet(X/x_0)\), \(H_n(X/x_0)\), \(H^n(X/x_0)\) (eventualmente a coefficienti in un gruppo abeliano \(G\)). La dimostrazione della seguente proposizione si può trovare in \citepage{massey}{71}.
