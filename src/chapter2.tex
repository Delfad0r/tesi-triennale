...
\end{proof}
% Y è un CW-complesso perché quoziente di CW-complessi, e dunque si immerge in R^n
...
\longexactsequence{\ldots\rar\&\pi_{i+1}(B,b)\rar\&\pi_i(F,e)\rar\&\pi_i(E,e)\rar\&\pi_i(B,b)\rar\&\ldots}{\ldots\rar\&\pi_2(B,b)\rar\&\pi_1(F,e)\rar\&\pi_1(E,e)\rar\&\pi_1(B,b).}
%\begin{diagram}
