...
Alla luce di questa proposizione, nel seguito utilizzeremo sempre (almeno quando $X$ sarà connesso per archi) l'abbreviazione $Q_\bullet(X)$ in luogo di $Q_\bullet(X/x_0)$, e analogamente per $D_\bullet(X)$, $C_\bullet(X)$, $H_i(X)$, $H^i(X)$.
