...
\section{Struttura moltiplicativa del termine \texorpdfstring{$E^*_2$}{E*2}}
...
\section{Semplificazione del termine \texorpdfstring{$E^*_2$}{E*2}}
...
Supponiamo che $G$ sia un PID, e che sia soddisfatta una delle due condizioni seguenti:
\begin{enumerate}
...
\begin{diagram}
H^1(B;G)\rar&H^1(E;G)\rar&H^1(F;G)\rar{d_1}&H^2(B;G)\rar&\ldots\rar&H^{p+q-2}(F;G)\rar{d_{p+q-2}}&H^{p+q-1}(B;G)\rar&H^{p+q-1}(E;G)\rar&H^{p+q-1}(F;G)
\end{diagram}
\end{proposition}

Riportiamo ora un risultato noto come "Successione esatta di Wang".
