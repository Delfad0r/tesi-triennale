...
\end{proposition}
Se $C^\bullet$ è munito di una struttura di anello, come spesso accade nelle applicazioni topologiche, allora ne esiste anche una indotta sui termini della successione spettrale associata. Più precisamente, supponiamo che sia definito un prodotto $\map{\cupp}{C^n\times C^m}{C^{n+m}}$ che soddisfa le seguenti proprietà:
\begin{enumerate}
