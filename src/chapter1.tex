...
Consideriamo uno spazio topologico $X$ che ammette un rivestimento universale $\map{p}{T}{X}$. Sia $\pi$ il gruppo fondamentale di $X$, e supponiamo che $\pi$ agisca banalmente sui gruppi di omologia di $T$. Sia inoltre $G$ un gruppo abeliano. Riportiamo il risultato fondamentale di \cite{cartan}, riformulato
