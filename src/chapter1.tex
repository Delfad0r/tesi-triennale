...
\end{align*}
Osserviamo in particolare che $E^{p,q}_0=C^p_n/C^{p-1}_n$. È immediato verificare che
\begin{align*}
...
I gruppi $E^{p,q}_r$, insieme alle mappe di bordo $d^{p,q}_r$, formano una successione spettrale con modulo terminale $E^{p,q}_\infty$. Inoltre $E^{p,q}_r\converges H_{p+q}(C_\bullet)$.
\end{proposition}
\begin{proof}
