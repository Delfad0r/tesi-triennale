...
Fissato un valore di \(r\), possiamo disporre i gruppi \(E^{p,q}_r\) su un reticolo bidimensionale con \(p\) e \(q\) come coordinate.

\drawsseq{homological}{0}
\drawsseq{homological}{1}
\drawsseq{homological}{2}
