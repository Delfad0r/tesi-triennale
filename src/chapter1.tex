...
\end{corollary}
\begin{proof}
Consideriamo la successione spettrale $E^{p,q}_r$ data dalla \thref{spectral-sequence-of-universal-covering}. È ben noto \cite{} che, se l'azione di $\ZZ$ su $H_q(T;G)$ è banale, allora
$$
...
\end{corollary}
\begin{proof}
Consideriamo la successione spettrale $E^{p,q}_r$ data dalla \thref{spectral-sequence-of-universal-covering}. È ben noto \cite[] che, con le ipotesi fatte, vale
$$
H_p(\pi;H_q(T;G))=
\begin{cases}
H_q(T;G)&p=0\\
