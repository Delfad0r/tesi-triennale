...
\section{H-spazi}
\begin{definition}
Sia \(\Omega\) uno spazio topologico munito di un prodotto \(\map{\vee}{\Omega\times \Omega}{\Omega}\) continuo. \(\Omega\) si dice \defterm{H-spazio} se esiste \(e\in \Omega\) con \(e\vee e=e\) tale che le applicazioni da \(\Omega\) in \(\Omega\) definite da \(x\mapsto x\vee e\) e \(x\mapsto e\vee x\) siano omotope all'identità mediante omotopie che fissano \(e\).
\end{definition}
