...
\todo{Rifare.}
Consideriamo la fibrazione $\fibration{\Omega}{E}{X}$ del \thref{loop-space-fibration}. Poiché $E$ è contrattile, i suoi gruppi di omologia sono finitamente generati. Applicando il Lemma si ottiene immediatamente la tesi.
\end{proof}