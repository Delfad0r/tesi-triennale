...
$$
I gruppi di omologia di $X_{n-1}$ sono finitamente generati per ipotesi induttiva, e $\pi$ è finitamente generato poiché $\pi=H_1(X_{n-1})$. \todo{E quindi? Io voglio $H_p(\pi)$ f.g.} % Vedi corollario 1, pag. 500
...
\begin{proof}
\begin{lemma*}
Dati $i>0,0\le j\le n-i$ vale $H_i(X_j;K)=H_{i+j}(X;K)$.
\end{lemma*}
\begin{proof}
